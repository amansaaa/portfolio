// Github, Twitter, LinkedIn, email, sun/moon toggle, external link

// Drawn in code instead of being image files; stays sharp at any size 
// and automatically text color (white in light mode, black in dark mode)
